...
const TIMELINE = [
  { year: "2021", title: "The Spark", desc: "We started in a small studio with a single magnet printer and a big dream." },
  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="pt-24 px-4 sm:pt-32 sm:px-6 pb-12 sm:pb-16 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-16">
        <Reveal>
          <h1 className="text-h1 text-foreground mb-4">About Magnetic Bliss in</h1>
        </Reveal>
        <Reveal delay={100}>
          <p className="text-muted-foreground max-w-lg mx-auto text-body">
            We believe every photo tells a story — and the best stories deserve to live beyond your phone screen. Magnetic Bliss in turns your favorite moments into beautiful, tangible magnets.
          </p>
        </Reveal>
      </div>
