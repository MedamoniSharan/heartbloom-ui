        ...
        <div className="text-center mb-14">
          ...
          <Reveal delay={140}>
            <p className="text-muted-foreground max-w-xl mx-auto text-lg">
              Real customers, real magnets, real smiles. See how HeartPrinted brings joy to fridges everywhere.
            </p>
          </Reveal>
        ...
        <Reveal delay={200}>
          <div className="text-center mt-16 bg-card border border-border rounded-2xl p-10 shadow-card">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Got your HeartPrinted magnets? Share a photo and join our Wall of Love. Tag us on social media!
            </p>
            <a
